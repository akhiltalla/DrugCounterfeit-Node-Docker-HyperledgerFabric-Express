...
async function registerCompany(orgType,reqPayload) { //register company
...
async function addDrug(orgType,reqPayload) {//add drug
...
async function viewDrugCurrentState(orgType,reqPayload) {//view Drug state
...
async function viewHistory(orgType,reqPayload) {//view history
...
async function createPO(orgType,reqPayload) {//create Po
...
async function createShipment(orgType,reqPayload) {// create shipment
...
async function updateShipment(orgType,reqPayload) {//update shipment
...
async function retailDrug(orgType,reqPayload) {// sell/retail drug
